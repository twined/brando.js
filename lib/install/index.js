...
export function installTemplates (store, templates) {
  store.commit('config/STORE_TEMPLATES', templates)
}

export function setTemplateMode (store) {
  store.commit('config/SET_TEMPLATE_MODE')
}
